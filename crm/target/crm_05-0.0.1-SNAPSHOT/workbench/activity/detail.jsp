...
<script type="text/javascript">
	...
	$(function(){
		...
		$(".myHref").mouseout(function(){
			$(this).children("span").css("color","#f8ffb3");
		});
	...
	function showRemark() {
		$.ajax({
			...
			success:function (data) {
				...
				html += '&nbsp;&nbsp;&nbsp;&nbsp;';
				html += '<a class="myHref" href="javascript:void(0);" onclick="delectRemark(\'' + n.id + '\')"><span class="glyphicon glyphicon-remove" style="font-size: 20px; color: #FF0000;"></span></a>';
				html += '</div>';
				html += '</div>';
				html += '</div>';
				})
	...
	function editRemark(id) {
	    ...
	    //对备份模态窗口的id赋值，才能让系统知道提交的是哪个窗口
        $("#remarkId").val(id);

	    var conText = $("#e"+ id).html();

	    $("#noteContent").val(conText);
	...
	function delectRemark(id) {
		$.ajax({
			url:"workbench/activity/delectRemark.do",
			data:{
				"id" : id
			},
			type:"post",
...
<body>
	...
	<div style="position: relative; top: -70px;">
		<div style="position: relative; left: 40px; height: 30px;">
			<div style="width: 300px; color: gray;">持有人</div>
